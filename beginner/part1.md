...
## Window managers
A desktop environment is a full package: preinstalled applications, a nice interface for everything, and a bunch of abstracting with settings menus. But what if you wanted to have a bit less? Enter the window manager. Every desktop environment has its own window manager, such as KWin for KDE, but things like i3 (pictured below) and Sway (pictured below i3) are their own window managers.

![i3](https://i3wm.org/screenshots/i3-3.png)
![Sway](https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Sway_1.4_Window_Manager.png/2560px-Sway_1.4_Window_Manager.png)

Many people use window managers for their near limitless customizability compared to traditional DEs (customization is often referred to as "ricing" your setup).
